...
class SecureStorageService {
  ...
  Future<void> clearSessionData() async {
    ...
    await _storage.delete(key: StorageConstants.refreshToken);
    await _storage.delete(key: StorageConstants.businessId);
    await _storage.delete(key: StorageConstants.defaultBusinessId);
    await _storage.delete(key: StorageConstants.syncCursor);

    final all = await _storage.readAll();
    final scopedPrefix = '${StorageConstants.syncCursorScopedPrefix}_';
